...
const componentsByPath = {
    ...
    "home": {name: "Home", projectId: "s5qqx2XSuQYkJY3sLachCa" },
  
    "pricing": {name: "Pricing", projectId: "s5qqx2XSuQYkJY3sLachCa" },
  
    "features": {name: "Features", projectId: "s5qqx2XSuQYkJY3sLachCa" },
